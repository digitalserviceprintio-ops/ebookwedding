// Audio synthesis utility using Web Audio API for interactive feedback
...
class SoundEffects {
  ...
  // Soft pleasant wedding chime / harmonic chord
  playCheckInChime() {
  ...
  // Soft celebratory chime for success / downloads
  playSuccess() {
